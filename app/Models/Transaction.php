 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, Transaction> get()
 * @method static Transaction create(array $attributes = [])
 * @method static Transaction firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Transaction where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Transaction whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
