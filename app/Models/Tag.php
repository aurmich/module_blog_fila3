 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, Tag> get()
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Tag whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
