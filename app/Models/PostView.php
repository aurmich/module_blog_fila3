 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, PostView> get()
 * @method static PostView create(array $attributes = [])
 * @method static PostView firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PostView where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|PostView whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
