 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, Comment> get()
 * @method static Comment create(array $attributes = [])
 * @method static Comment firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Comment where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Comment whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
