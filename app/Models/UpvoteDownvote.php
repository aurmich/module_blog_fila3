 ...
 * @method static \Illuminate\Database\Eloquent\Collection<int, UpvoteDownvote> get()
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|UpvoteDownvote where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|UpvoteDownvote whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
